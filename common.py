...
def add_lag_features(df: pd.DataFrame, target_column: str, lags) -> pd.DataFrame:
...
def add_rolling_features(df: pd.DataFrame, target_column: str, windows) -> pd.DataFrame:
